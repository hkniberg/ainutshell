...
It started as a fun little experiment. I was sitting on the porch with my cousin and my kids, goofing around with ChatGPT, trying to see if we could generate a role-playiung game. We wrote a prompt like this:
